...
highlight = (
    alt.Chart(sel)
    .mark_point(size=320, shape="circle", filled=False, strokeWidth=3)
    .encode(
...
show_cols = (
    ["nickname", "team", "position_group", "minutes"]
